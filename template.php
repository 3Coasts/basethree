 ...
 * - toolbar.css
 */
function basethree_css_alter(&$css) {
  $exclude = array(
...
function basethree_theme() {
  ...
  $items['block'] = array(
    ...
    'template' => 'object',
    'path' => drupal_get_path('theme', 'basethree') .'/templates',
  );
  $items['comment'] = array(
 ...
 */
function basethree_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'basethree';
}

/**
 * Implementation of preprocess_page().
 */
function basethree_preprocess_page(&$vars) {
 ...
 */
function basethree_preprocess_block(&$vars) {
  $vars['hook'] = 'block';
 ...
 */
function basethree_preprocess_node(&$vars) {
  $vars['hook'] = 'node';
 ...
 */
function basethree_preprocess_comment(&$vars) {
  $vars['hook'] = 'comment';
 ...
 */
function basethree_preprocess_fieldset(&$vars) {
 ...
 */
function basethree_preprocess_field(&$vars) {
 ...
 */
function basethree_textarea($variables) {
 ...
 */
function basethree_pager_list($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
  $quantity = $vars['quantity'];
 ...
 */
function basethree_pager_link($vars) {
  $text = $vars['text'];
 ...
 */
function basethree_views_mini_pager($vars) {
  $tags = $vars['tags'];
  $quantity = $vars['quantity'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
